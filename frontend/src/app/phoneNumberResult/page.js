    ...
    return (
        ...
        <div>
            ...
            <div style={{lineHeight:0.5,marginTop:50,marginBottom:50}}>
                <h1 style={{display:'flex',flexDirection:'column',alignItems:'center',color:'green'}}>PHONE NUMBER IS SAFE</h1>
                <p style={{display:'flex',flexDirection:'column',alignItems:'center',color:'blue',textDecoration:'underline',cursor:'pointer'}}>9080111914</p>
            </div>
